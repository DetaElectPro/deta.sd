...
const translations = {
  ar: {
    ...
    // Home
    'home.hero.quote_cta': 'اطلب عرض سعر',
    'home.hero.scroll': 'اكتشف المزيد',
    'home.hero.whatsapp_label': 'تواصل واتساب',
    'home.trust.countries_label': 'دولة نخدمها',
    'home.trust.response_label': 'استجابة خلال 24 ساعة',
    'home.trust.quality_label': 'فحص جودة لكل شحنة',
    'home.process.title': 'من المزرعة إلى السفينة',
    'home.process.description': 'عملية تصدير محكمة تضمن الجودة والتوثيق الكامل في كل مرحلة، من الحصاد حتى التسليم على متن السفينة.',
    'home.process.step1_title': 'المصدر والحصاد',
    'home.process.step1_desc': 'شراء مباشر من مزارع القضارف وكردفان مع توثيق المنشأ وضمان جودة المحصول من المصدر.',
    'home.process.step2_title': 'الفرز والمختبر',
    'home.process.step2_desc': 'فرز وتنقية دقيقة مع فحص الرطوبة والنقاوة في المختبر لضمان مطابقة المواصفات العالمية.',
    'home.process.step3_title': 'التوثيق والتغليف',
    'home.process.step3_desc': 'إصدار شهادات المنشأ والصحة النباتية مع تغليف محكم للحاويات يحفظ جودة الشحنة.',
    'home.process.step4_title': 'ميناء بورتسودان والشحن',
    'home.process.step4_desc': 'تخليص جمركي سريع وشحن بنظام FOB أو CIF من ميناء بورتسودان إلى أي ميناء عالمي.',
    'home.markets.title': 'أسواق نخدمها',
    'home.markets.description': 'نصدّر المحاصيل السودانية الأصيلة إلى أسواق الخليج وآسيا وأوروبا وأفريقيا بموثوقية عالية.',
    'home.markets.note': 'لا ترى دولتك؟ نشحن لأي ميناء آمن حول العالم.',
    'home.quality.title': 'التزامات الجودة',
    'home.quality.description': 'نلتزم في كل شحنة بأعلى معايير الفحص والتوثيق والتغليف لنضمن وصول منتج يليق بثقة عملائنا.',
    'home.quality.item1_title': 'فحص مخبري لكل دفعة',
    'home.quality.item1_desc': 'تحليل مخبري معتمد لكل دفعة يشمل الرطوبة والنقاوة والجودة قبل الشحن.',
    'home.quality.item2_title': 'توثيق تخليص كامل',
    'home.quality.item2_desc': 'مستندات تصدير متكاملة تشمل شهادة المنشأ والصحة النباتية وشهادة التحليل.',
    'home.quality.item3_title': 'تغليف حاويات محكم',
    'home.quality.item3_desc': 'تعبئة وتغليف احترافي للحاويات يحمي الشحنة من الرطوبة والتلف أثناء النقل.',
    'home.quality.item4_title': 'رد خلال 24 ساعة',
    'home.quality.item4_desc': 'فريق مبيعات متخصص يرد على استفساراتكم وعروض الأسعار خلال 24 ساعة.',
    'home.news.title': 'آخر الأخبار',
    'home.news.description': 'تابع أحدث أخبار مجموعة ديتا وأنشطة التصدير ومواسم الحصاد.',
    'home.news.view_all': 'كل الأخبار',
    'home.faq.title': 'أسئلة شائعة',
    'home.faq.description': 'إجابات عن أكثر الأسئلة تكراراً حول الطلب والشحن والدفع والمستندات.',
    'home.faq.q1': 'ما الحد الأدنى للطلب؟',
    'home.faq.a1': 'الحد الأدنى لمعظم الأصناف هو حاوية 20 قدم، مع إمكانية دراسة الطلبات الخاصة حسب المنتج والوجهة.',
    'home.faq.q2': 'هل الشحن FOB أم CIF؟',
    'home.faq.a2': 'نوفر كلا الخيارين من ميناء بورتسودان: FOB أو CIF حتى ميناء الوصول حسب الاتفاق مع العميل.',
    'home.faq.q3': 'ما طرق الدفع المعتمدة؟',
    'home.faq.a3': 'نقبل الاعتماد المستندي والتحويل البنكي T/T المعتمد وفق شروط متفق عليها تضمن حقوق الطرفين.',
    'home.faq.q4': 'كم تستغرق مدة الشحن؟',
    'home.faq.a4': 'تتراوح مدة الشحن عادة بين 7 و25 يوماً حسب ميناء الوجهة وخط الشحن وجداول الإبحار.',
    'home.faq.q5': 'هل تتوفر عينات من المنتجات؟',
    'home.faq.a5': 'نعم، نوفر عينات عند الطلب ليتمكن العميل من فحص الجودة قبل تأكيد الطلب.',
    'home.faq.q6': 'ما المستندات المرفقة مع الشحنة؟',
    'home.faq.a6': 'نرفق شهادة المنشأ وشهادة الصحة النباتية وشهادة التحليل مع كامل مستندات التخليص والشحن.',
    'home.about.img_alt': 'صور عمليات ديتا'
  },
  en: {
    // Site Info
    ...
    // Home
    'home.hero.quote_cta': 'Request a Quote',
    'home.hero.scroll': 'Discover More',
    'home.hero.whatsapp_label': 'Chat on WhatsApp',
    'home.trust.countries_label': 'Countries Served',
    'home.trust.response_label': '24-Hour Response',
    'home.trust.quality_label': 'Quality-Checked Shipments',
    'home.process.title': 'From Farm to Vessel',
    'home.process.description': 'A tightly managed export process ensuring quality and full documentation at every stage, from harvest to on-board delivery.',
    'home.process.step1_title': 'Sourcing & Harvest',
    'home.process.step1_desc': 'Direct sourcing from Gedaref and Kordofan farms with documented origin and farm-gate quality assurance.',
    'home.process.step2_title': 'Sorting & Lab',
    'home.process.step2_desc': 'Precise sorting and cleaning with lab testing for moisture and purity to meet international specifications.',
    'home.process.step3_title': 'Docs & Packing',
    'home.process.step3_desc': 'Certificates of origin and phytosanitary certificates with secure container packing that preserves cargo quality.',
    'home.process.step4_title': 'Port Sudan & Shipping',
    'home.process.step4_desc': 'Fast customs clearance and FOB/CIF shipping from Port Sudan to any global port.',
    'home.markets.title': 'Markets We Serve',
    'home.markets.description': 'We export authentic Sudanese crops to the Gulf, Asia, Europe, and Africa with proven reliability.',
    'home.markets.note': "Don't see your country? We ship to any safe port worldwide.",
    'home.quality.title': 'Quality Commitments',
    'home.quality.description': 'Every shipment meets our highest standards for inspection, documentation, and packing to earn our customers\u2019 trust.',
    'home.quality.item1_title': 'Every-batch lab testing',
    'home.quality.item1_desc': 'Certified lab analysis for every batch covering moisture, purity, and quality before shipment.',
    'home.quality.item2_title': 'Complete clearance documentation',
    'home.quality.item2_desc': 'Full export paperwork including certificate of origin, phytosanitary certificate, and certificate of analysis.',
    'home.quality.item3_title': 'Secure container packing',
    'home.quality.item3_desc': 'Professional container stuffing and packing that protects cargo from moisture and damage in transit.',
    'home.quality.item4_title': '24-hour response',
    'home.quality.item4_desc': 'A dedicated sales team responding to inquiries and quotations within 24 hours.',
    'home.news.title': 'Latest News',
    'home.news.description': 'Follow the latest Deta Group news, export activity, and harvest seasons.',
    'home.news.view_all': 'View All News',
    'home.faq.title': 'FAQ',
    'home.faq.description': 'Answers to the most common questions about ordering, shipping, payment, and documents.',
    'home.faq.q1': 'What is the minimum order quantity?',
    'home.faq.a1': 'The MOQ for most items is one 20ft container, with special requests considered by product and destination.',
    'home.faq.q2': 'Do you offer FOB or CIF?',
    'home.faq.a2': 'We offer both from Port Sudan: FOB or CIF to the destination port as agreed with the customer.',
    'home.faq.q3': 'What payment methods do you accept?',
    'home.faq.a3': 'We accept letter of credit and approved T/T bank transfer under mutually agreed terms that protect both parties.',
    'home.faq.q4': 'How long does shipping take?',
    'home.faq.a4': 'Shipping typically takes 7\u201325 days depending on the destination port, shipping line, and sailing schedules.',
    'home.faq.q5': 'Are product samples available?',
    'home.faq.a5': 'Yes, samples are available on request so you can verify quality before confirming your order.',
    'home.faq.q6': 'Which documents accompany the shipment?',
    'home.faq.a6': 'We include the certificate of origin, phytosanitary certificate, and certificate of analysis with full clearance and shipping documents.',
    'home.about.img_alt': 'Deta operations photos'
  }
};
